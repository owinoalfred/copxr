 ...
 */
import SubmitGroupForm from './SubmitGroupForm.vue'
import loadi18n from '@/i18n/async'

const rootElements = document.querySelectorAll('.submit-group-form')
...
async function mountForm(rootElement) {
    ...
    const component = new SubmitGroupForm({ propsData, i18n })
